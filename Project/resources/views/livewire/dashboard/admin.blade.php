<div class="h-screen w-full p-4 overflow-y-auto md:pb-4 pb-36">
    <div class="w-full px-6 mx-auto">
        ...
        <br>
        <div class="flex">
            <div class="relative items-center p-0 mt-8 overflow-hidden bg-center bg-cover h-40 rounded-2xl w-1/3 mr-4">
                <span
            ...
            <div class="relative items-center p-0 mt-8 overflow-hidden bg-center bg-cover h-40 rounded-2xl w-1/2">
                <span
                    class="absolute inset-0 bg-center bg-cover bg-gradient-to-tl from-gray-50 to-gray-300 opacity-70 rounded-3 border-3 h-full"></span>
                <div class="grid grid-cols-1 gap-2 p-2 mt-2 relative">
        ...
        <div class="w-full rounded-2xl border-gray-400 flex gap-4 mt-4">
            <div class="relative flex items-center p-0 mt-8 overflow-hidden bg-center bg-cover h-80 rounded-2xl w-1/2">
                <span
