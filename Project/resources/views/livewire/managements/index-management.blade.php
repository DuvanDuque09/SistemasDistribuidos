...
<div class="grid md:grid-cols-2 grid-cols-1 h-screen w-full p-4 md:overflow-hidden overflow-y-auto md:pb-4 pb-36">
    ...
    <div class="flex flex-col md:h-[98%] w-[99%] p-4 gap-4 md:relative">
        ...
        <div class="bg-white md:w-[97%] md:h-[68%] pb-6 px-4 rounded-lg shadow md:absolute bottom-0 overflow-y-auto"
            x-data="{ tab: 'Consultas' }">
            <div class="bg-white sticky top-0 z-20 left-0 right-0 md:h-[72px] h-20 w-full">
                <div class="pt-4">
            ...
            <div class="flex flex-col h-full mt-6 gap-4" x-show="tab === 'Productos'">
                ...
                <div class="flex flex-col rounded-lg bg-gray-50 text-gray-500" x-data="{ openD: false }">
                    <div class="flex cursor-pointer items-center justify-between py-2 px-5" @click="openD = !openD"
                        ...
                        <svg viewBox="0 0 24 24" class="w-6 h-6 group-hover:text-gray-200 text-gray-500 rotate-180"
                ...
                <div class="flex flex-col rounded-lg bg-gray-50 text-gray-500" x-data="{ openC: false }">
                    <div class="flex cursor-pointer items-center justify-between py-2 px-5" @click="openC = !openC"
            ...
            <div class="py-6 px-2">
                <dl class="grid md:grid-cols-2 grid-cols-1 gap-x-4 gap-y-4">
                    <div class="col-span-1">
                        ...
                        <select wire:model="tipo_consulta"
                        ...
                        <x-input-error for="tipo_cartera" />
                    </div>
                    <div class="col-span-1">
                        <dt class="text-sm font-medium text-gray-500">Teléfono</dt>
                    ...
                    <div class="col-span-2">
                        ...
                        <textarea rows="10" wire:model="management"
                    ...
                    <div class="col-span-2 border-b-2 border-gray-600">
                        <h4 class="text-lg leading-6 font-medium text-gray-900">Obligación</h4>
                        <p class="mt-1 max-w-2xl text-sm text-gray-500">Información de la obligación</p>
                    </div>
                    <div class="col-span-1">
                        <dt class="text-sm font-medium text-gray-500">Numero de la obligación</dt>
                        <div class="mt-1 border-b border-gray-300 focus-within:border-indigo-600">
                            <input type="text" wire:model="obligation"
                                class="block w-full border-0 border-b border-transparent bg-gray-50 focus:border-indigo-600 focus:ring-0 sm:text-sm">
                        </div>
                        <x-input-error for="obligation" />
                    </div>
                </dl>
