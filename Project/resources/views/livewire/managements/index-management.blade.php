                ...
                <div class="mt-4">
                    ...
                    <div class="flex gap-2">
                        <x-input id="identification" class="block mt-1 w-full" type="text" wire:model="identification"
                            disabled wire:keydown.enter="searchCustomer" name="identification" autofocus />
                ...
                <div class="bg-white w-full h-full py-6 px-4 rounded-lg grid grid-cols-2 shadow">
                    ...
                    <div>
                        ...
                        <div class="mt-4">
                            <x-label for="identification" value="{{ __('Número de Identificación') }}" />
                            <div class="flex gap-2">
                                {{ $customer['code'] }} {{ number_format($customer['identification'], 0, '.', '.') }}
                            </div>
                        </div>
                    </div>
                ...
                <div class="flex flex-col h-full mt-6 gap-4" x-show="tab === 'Datos'">
                    ...
                    <div class="grid md:grid-cols-4 grid-cols-1 gap-3">
                        <div class="col-span-2 md:mt-0 mt-1">
                            ...
                            <x-input class="block mt-1 w-full" disabled wire:model="customer.person" />
                        </div>
                        <div class="col-span-1 md:mt-0 mt-1">
                            <dt class="text-sm font-medium text-gray-500">Tipo de Identificación</dt>
                            <select wire:model="customer.identification_type_id" disabled
                                class="cursor-not-allowed mt-1 w-full bg-gray-50 rounded-md border-none focus:border-red-500 focus:ring-red-500 shadow-sm">
                        ...
                        <div class="col-span-1 md:mt-0 mt-1">
                            ...
                            <x-input class="block mt-1 w-full" disabled wire:model="customer.identification" />
                        </div>
                        <div class="col-span-1 md:mt-0 mt-1">
                            <dt class="text-sm font-medium text-gray-500">Género</dt>
                            <select wire:model="customer.gender" disabled
                                class="cursor-not-allowed mt-1 w-full bg-gray-50 rounded-md border-none focus:border-red-500 focus:ring-red-500 shadow-sm">
                                <option value="">Seleccione</option>
                        ...
                        <div class="col-span-1 md:mt-0 mt-1">
                            ...
                            <x-input class="block mt-1 w-full" disabled wire:model="customer.birthdate" />
                        </div>
                        <div class="col-span-1 md:mt-0 mt-1">
                            <dt class="text-sm font-medium text-gray-500">Teléfono</dt>
                            <x-input class="block mt-1 w-full" disabled wire:model="customer.phone" />
                        </div>
                        <div class="col-span-1 md:mt-0 mt-1">
                            <dt class="text-sm font-medium text-gray-500">Ocupación</dt>
                            <x-input class="block mt-1 w-full" disabled wire:model="customer.ocupation" />
                        </div>
                        <div class="col-span-2 md:mt-0 mt-1">
                            <dt class="text-sm font-medium text-gray-500">Dirección</dt>
                            <x-input class="block mt-1 w-full" disabled wire:model="customer.address" />
                        </div>
                        <div class="col-span-2 md:mt-0 mt-1">
                            <dt class="text-sm font-medium text-gray-500">Correo Electrónico</dt>
                            <x-input class="block mt-1 w-full" disabled wire:model="customer.email" />
                        </div>
                        <div class="col-span-2 md:mt-0 mt-1">
                            <dt class="text-sm font-medium text-gray-500">Estado</dt>
                            <select wire:model="customer.state" disabled
                                class="cursor-not-allowed mt-1 w-full bg-gray-50 rounded-md border-none focus:border-red-500 focus:ring-red-500 shadow-sm">
                                <option value="">Seleccione</option>
                                ...
                                <tbody class="bg-white divide-y divide-gray-200">
                                    <tr>
                                        <td class="pt-[14px] pb-[18px] sm:text-[14px] text-center">
                                            <p class="text-sm font-bold text-gray-500">Aclaración de Saldos</p>
                                        </td>
                                        <td class="pt-[14px] pb-[18px] sm:text-[14px] text-center">
                                            <div class="flex items-center justify-center gap-2">
                                                ...
                                                <p class="text-sm font-bold text-gray-500">Tarjeta de Crédito</p>
                                            </div>
                                        </td>
                                        <td class="pt-[14px] pb-[18px] sm:text-[14px] text-center">
                                            <p class="text-sm font-bold text-gray-500">18/04/2024</p>
                                        </td>
                                        <td class="pt-[14px] pb-[18px] sm:text-[14px] text-center">
                                            <div class="flex items-center justify-center">
                                                ...
                                                <div>
                                                    <div
                                                        class="leading-none text-xs font-medium text-gray-900 whitespace-normal">
                                                        Danilo Ivañes
                                                    </div>
                                                </div>
                                            </div>
            ...
            <div class="bg-white md:h-[97%] md:w-[97%] py-6 px-4 rounded-lg shadow md:absolute overflow-y-auto">
                ...
                <div class="py-6 px-2">
                    <dl class="grid md:grid-cols-2 grid-cols-1 gap-x-4 gap-y-4">
                        ...
                        <div class="col-span-1">
                            <dt class="text-sm font-medium text-gray-500">Teléfono</dt>
                            <x-input id="phone" class="block mt-1 w-full bg-gray-50 border-none" type="number"
                                name="phone" />
                        ...
                        <div class="col-span-2">
                            ...
                            <fieldset>
                                ...
                                <div class="mt-4">
                                    @for ($i = 0; $i < 3; $i++)
                                        <div
                                            class="flex items-center py-3.5 px-4 gap-4 border-b border-[#e5e7eb] bg-red-300/10 rounded-lg">
                                            <label for="account-checking" class="flex-1 flex items-center gap-4">
                                                <div class="jw lx oc yz">
                                                    <input id="account-checking"
                                                        aria-describedby="account-checking-description" name="account"
                                                        type="radio"
                                                ...
                                                <div class="flex-1 flex gap-4">
                                                    <div class="flex items-center justify-center flex-shrink-0">
                                                        <img class="w-auto h-12 rounded-md object-cover"
                                                            src="{{ Storage::url('recursos/Ahorros.png') }}"
                                                            alt="" />
                                                    </div>
                                                    <div class="flex flex-col">
                                                        <label for="account-checking"
                                                            class="font-medium">Checking</label>
                                                        <p id="account-checking-description"
                                                            class="text-gray-600 text-sm">CIBC
                                                            ••••6610</p>
                                                    </div>
                                                </div>
                                            </label>
